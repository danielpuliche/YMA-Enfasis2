...
<body class="main-layout" style="  min-height: 100vh;
   ...
   <div id="about" class="center about top_layer">
      ...
      <div>
         <a type="button" class="text-center pt-3" href="#" style="text-align: center; background-color:#484295; min-height: 8vh; width: 100%; color:#FFFFFF;  vertical-align: middle; justify-content: center;">Inicio Página</a>
      </div>
